...
git add frontend/src/components/PortfolioTab.jsx core/portfolio_manager.py
git commit -m "fix: real 14d ATR in portfolio, ATR badge + price level graph in PortfolioTab"
