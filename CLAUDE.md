...
### `a3d5521` — L3 monitor in-process checks (no self-HTTP timeouts)
### `967282a` — AMA agent, Opus deep research, stability fixes
### `9ec7893` — parallel health checks (frozen stack — see CURSOR-AGENT-BRIEF.md)
